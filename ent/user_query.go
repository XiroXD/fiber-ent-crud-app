...
func (uq *UserQuery) loadPets(ctx context.Context, query *PetQuery, nodes []*User, init func(*User), assign func(*User, *Pet)) error {
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(user.PetsTable)
		s.Join(joinT).On(s.C(pet.FieldID), joinT.C(user.PetsPrimaryKey[1]))
		s.Where(sql.InValues(joinT.C(user.PetsPrimaryKey[0]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(user.PetsPrimaryKey[0]))
